...
"""
Teste de filtro para reviews com comentários - produto com reviews reais
"""
...
def test_reviews_with_comments_real():
    print("Testando filtro para reviews com comentários - produto com reviews reais...")
    
    # URL de teste (produto com reviews que possuem comentários)
    test_url = "https://www.mercadolivre.com.br/kit-cartucho-tinta-original-hp-667-pretocolorido-2376-2774/up/MLBU750370459"
            ...
            if 'reviews_data' in produto_com_reviews:
                ...
                for i, review in enumerate(reviews_list):
                    ...
                    if has_comment and comment and comment.strip():
                        ...
                        print(f"Review {i+1}: Rating={rating}, Title={title}, Comment={comment[:100]}...")
                    else:
                ...
                csv_file = sistema.gerar_dataset_csv(
                    filename="test_reviews_with_comments_real.csv",
                    ...
                    if review_columns:
                        ...
                        if len(df) > 0:
                            ...
                            for i in range(1, 6):
                                ...
                                if review_id != 'N/A':
                                    print(f"Review {i}: ID={review_id}, Rating={review_rating}, Title={review_title}, Comment={review_comment[:100]}...")
                                else:
...
if __name__ == "__main__":
    test_reviews_with_comments_real()
